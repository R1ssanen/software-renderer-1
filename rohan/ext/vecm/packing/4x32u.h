...
minline m4x32u _madd4x32u_4x32u(const m4x32u _a, const m4x32u _b) { return _mm_add_epi32(_a, _b); }

minline m4x32u _msub4x32u_4x32u(const m4x32u _a, const m4x32u _b) { return _mm_sub_epi32(_a, _b); }

/** @brief Arithmeric Scalar */
minline m4x32u _madd4x32u_u32(const m4x32u _p, u32 _s) { return _mm_add_epi32(_p, mset4x32u(_s)); }

minline m4x32u _msub4x32u_u32(const m4x32u _p, u32 _s) { return _mm_sub_epi32(_p, mset4x32u(_s)); }
