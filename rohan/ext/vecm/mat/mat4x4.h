...
minline mmat4f mtranspose4x4f(mmat4f _a) {
    _vecm128f_Transpose4(_a._m[0].v, _a._m[1].v, _a._m[2].v, _a._m[3].v);
    return _a;
}

/** @brief Arithmetic Matrix */
minline mmat4f _madd4x4f_mat4f(mmat4f _a, mmat4f _b) {
    return (mmat4f){
        ._m = { madd4f(_a._m[0], _b._m[0]), madd4f(_a._m[1], _b._m[1]), madd4f(_a._m[2], _b._m[2]) }
    };
}

minline mmat4f _msub4x4f_mat4f(mmat4f _a, mmat4f _b) {
    return (mmat4f){
        ._m = { msub4f(_a._m[0], _b._m[0]), msub4f(_a._m[1], _b._m[1]), msub4f(_a._m[2], _b._m[2]) }
    };
}

minline mmat4f _mmul4x4f_mat4f(mmat4f _a, mmat4f _b) {
    _vecm128f_Transpose4(_b._m[0].v, _b._m[1].v, _b._m[2].v, _b._m[3].v);
...
minline mvec4f _mmul4x4f_vec4f(mmat4f _m, mvec4f _v) {
    return mpack4f(
